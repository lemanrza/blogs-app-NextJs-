...
//                                 Blogs
//                             </Link>
//                             <Link href="/about" className="hover:text-primary-light dark:hover:text-primary-dark transition-colors duration-300">
//                                 About
//                             </Link>
//                             <Link href="/projects" className="hover:text-primary-light dark:hover:text-primary-dark transition-colors duration-300">
//                                 Projects
//                             </Link>
